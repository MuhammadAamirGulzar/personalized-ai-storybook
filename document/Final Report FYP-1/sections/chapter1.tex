...
The personalized-ai-storybook system architecture is organized into six comprehensive modules, each responsible for specific aspects of the complete story generation, interaction, and presentation pipeline.
...
muhammadaamirgulzar Kiyani & muhammadaamirgulzar & Director + Reviewer Agent Modules: Ollama setup, story generation pipeline, Reviewer Agent for story enhancement, Personalized Story Mode, IP-Adapter integration, Text-to-Speech (voice narration), multi-agent optimization, testing and bug-fixing \\ \hline
muhammadaamirgulzar & muhammadaamirgulzar & Writer + UI Module: Stable Diffusion installation and pipeline setup, illustration generation, interactive book UI (page flipping, PDF export), dropdowns for genre/style/length, personalized/simple UI modes, final UI polishing with tabs and transitions \\ \hline
muhammadaamirgulzar & muhammadaamirgulzar & Interface + Context Modules: Basic user interface development, backend connection (story + image display), interactive chatbot with context saving, multi-page story pipeline, character chatbot powered by story context, full pipeline integration, testing, bug-fixing, deployment \\ \hline
\end{tabular}
